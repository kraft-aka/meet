...
//   redirect_uris: ["https://kraft-aka.github.io/meet/"],
//   javascript_origins: ["https://kraft-aka.github.io", "https://localhost:3000"],
// };
...
const credentials = {
  ...
  auth_provider_x509_cert_url: "https://www.googleapis.com/oauth2/v1/certs",
  redirect_uris: ["https://kraft-aka.github.io/meet/"],
  javascript_origins: ["https://kraft-aka.github.io", "http://localhost:3000"],
};
const { client_secret, client_id, redirect_uris, calendar_id } = credentials;
const oAuth2Client = new google.auth.OAuth2(
  client_id,
